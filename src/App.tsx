...
const [isLogerOpen, setIsLogerOpen] = useState(false)
...
const handleDeleteBoard = () => {
  ...
  return (
    <div className={appContainer}>
      {isLogerOpen ? <LoggerModal  setIsLogerOpen={setIsLogerOpen} /> : null}
      ...
      <div className={buttons}>
        ...
        <button className={loggerButton} onClick={() => setIsLogerOpen(!isLogerOpen)}>
          {isLogerOpen ? "활동 목록 숨기기" : "활동 목록 보이기"}
        </button>
      </div>
